...
// Έπειτα η κλάση BinaryTree θα εμπεριέχει την ρίζα του δέντρου, τη μέθοδο εισαγωγής τιμών,
// την αναδρομική μέθοδο εισαγωγής τιμών, όπως και τη προδιατεταγμένη μορφή (preorder), την
// ενδοδιατεταγμένη μορφή (inorder) και την μεταδιατεταγμένη (postorder).
class BinaryTree {
